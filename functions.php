...
function sela_scripts_styles() {
	...
	wp_enqueue_script( 'sticky-menu', get_template_directory_uri() . '/js/sticky-menu.js', array( 'jquery' ), '20140813', true);
	wp_enqueue_script( 'questions-reponses', get_template_directory_uri() . '/js/questions-reponses.js', array( 'jquery' ), '20140813', true);
